...
word_to_phrase_dict = {1: 'one', 2: 'two', 3: 'three', 4: 'four', 5: 'five', 6: 'six',
                       ...
                       57: 'fifty-seven', 58: 'fifty-eight', 59: 'fifty-nine', 60: 'sixty', 61: 'sixty-one',
                       62: 'sixty-two', 63: 'sixty-three', 64: 'sixty-four', 65: 'sixty-five',
...
hundred_dict = {1: 'one hundred & ', 2: 'two hundred & ', 3: 'three hundred & ', 4: 'four hundred & ', 5: 'five hundred & ',
                6: 'six hundred & ', 7: 'seven hundred & ', 8: 'eight hundred & ', 9: 'nine hundred & '}
number = int(input('give me a number\n'))
if number > 101:
    hundreds_num = (hundred_dict[(int(number) // 100)] + (word_to_phrase_dict[obtain_digits(number)]))
    print(hundreds_num)
elif number < 100:
