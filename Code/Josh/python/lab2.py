...
if x == 'yes':
    print('sorry I\'m a simple Mad Libs program but keep dreaming')
if x == 'no':
    print('I try and give you everything you enjoy in life and you\'re still not happy what\'s wrong with you?')
