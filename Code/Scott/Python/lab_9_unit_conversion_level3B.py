...
meter_dict = {'m': 1, 'ft': 3.28, 'yd': 1.0936, 'mi': 0.00062137, 'cm': 100, 'km': .001, 'mm': 1000}

#inputs

input_number = float(input('What is the distance? Please enter a number:\n'))
input_unit = input('What unit of measurement is this? m, ft, yd, mi, cm, km, or mm:\n')
while input_unit not in meter_dict.keys():
    input_unit = input('m, ft, yd, mi, cm, km, or mm:\n')
